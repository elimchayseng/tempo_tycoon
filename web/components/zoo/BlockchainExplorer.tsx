  ...
  return (
    <div className="h-full flex flex-col bg-[var(--zt-green-dark)]">
      ...
      <div className="zt-titlebar flex items-center justify-between shrink-0">
        <span className="text-[10px]">🖥️ BLOCKCHAIN</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        ...
        <div className="border-b border-[var(--zt-green-mid)]">
          <div className="px-3 py-1.5 font-pixel text-[7px] text-[var(--zt-tan)] uppercase tracking-widest bg-[var(--zt-green-mid)]/30">
            📡 Network
          </div>
