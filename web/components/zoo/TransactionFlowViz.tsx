  ...
  return (
    <div className="px-3 py-2 space-y-2">
      {agentFlows.map((flow) => {
        ...
        return (
          <div key={flow.agentId} className="zt-inset px-2 py-1.5" style={{ background: "rgba(0,0,0,0.2)" }}>
            {/* Agent header */}
            <div className="flex items-center gap-1.5 mb-1">
              <span className="text-sm">{agentEmoji}</span>
              <span className="font-pixel text-[7px] text-[var(--zt-tan)]">
            ...
            <div className="flex items-center gap-0.5">
              {STAGES.map((s, i) => {
                ...
                return (
                  <div
                    key={s.stage}
                    className={`flex items-center gap-0.5 px-1 py-0.5 text-[7px] font-pixel ${
                      isActive
            ...
            {flow.txHash && (
              <div className="mt-1">
                <a
                  ...
                  className="font-mono text-[7px] text-[var(--zt-green-light)] hover:text-[var(--zt-gold)] hover:underline"
                >
